...
public class OpenWebslidesConverter {
    ...
    /**
     * Starts the converter with the given arguments. The result is written as a
     * zip file to the outputStream. Logging is done to queue with the id.
     *
     * @param args The arguments for the converter.
     ...
     * @throws WebslidesConverterException If something went wrong while
     * converting.
     */
    ...
    /**
     * Parses the arguments args and returns a CommandLine object which holds
     * the info.
     *
    ...
    /**
     * Gets the Output object specified in cmd. If none is specified a StdOutput
     * object is returned.
     *
    ...
    /**
     * Reads the CommandLine and sets the course and chapter of the converter if
     * available.
     *
     * @param converter The converter on which the course and chapter will be
     * set.
     ...
     * @throws InvalidParameterException If the input file is not specified in
     * cmd.
     */
    ...
    /**
     * Returns the output directory in which the converted file should be saved.
     * If not specified in cmd the directory set in the converter.properties
     * file is used. If none of both is set the default is used.
     *
     * @param cmd The CommandLine that could hold the output directory.
     * @return Returns the output folder in which the converted file should be
     * saved.
     * @throws IOException If the output directory does not exist or could not
     * be created.
     */
    ...
    /**
     * Returns the output type specified in cmd. If not specified in cmd the
     * directory set in the converter.properties file is used. If none of both
